...
@Component({
  selector: 'app-community-poster-detail',
  templateUrl: './community-poster-detail.component.html',
  styleUrls: ['./community-poster-detail.component.scss']
})
export class CommunityPosterDetailComponent implements OnInit {
